...
#ifndef PROTOBUF_example_2fservice_2eproto__INCLUDED
#define PROTOBUF_example_2fservice_2eproto__INCLUDED
...
class EntriesRequest : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_example_2fservice_2eproto();
  friend void protobuf_AssignDesc_example_2fservice_2eproto();
  friend void protobuf_ShutdownFile_example_2fservice_2eproto();
...
class Entry : public ::google::protobuf::Message {
 ...
 private:
  ...
  ::std::string* home_;
  static const ::std::string _default_home_;
  ::std::string* shell_;
  static const ::std::string _default_shell_;
  friend void  protobuf_AddDesc_example_2fservice_2eproto();
  friend void protobuf_AssignDesc_example_2fservice_2eproto();
  friend void protobuf_ShutdownFile_example_2fservice_2eproto();
...
#endif  // PROTOBUF_example_2fservice_2eproto__INCLUDED
